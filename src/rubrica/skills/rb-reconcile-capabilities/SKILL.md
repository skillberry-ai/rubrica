...
outcome-class information from claims of every `kind`, `capability` included, because
...
your first capability, not once you have them all, and append the rest with
...
and appended to it -- this pass with 3 `Write` calls and 23 `Edit`s,
