...
your actors and your first goal, not once you have them all, and append the
rest with `Edit`. Do not compose the whole document in one turn.** This is a
budget instruction like the one above it, and it bounds the term that one says
nothing about -- your own output. Measured on a 149-input corpus:
