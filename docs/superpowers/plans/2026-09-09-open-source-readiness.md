...
- **Never edit `docs/superpowers/`** except to add a new dated file. It is recorded history: a record of what happened is falsified, not corrected, by a later edit.
