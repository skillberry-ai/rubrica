...
#
# docs/guides/invoking-rubrica.md is the runbook this automates; §7 there covers
...
# The dispatch prompt, verbatim from docs/guides/invoking-rubrica.md §2. Nothing
